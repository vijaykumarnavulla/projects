...
useEffect(() => {
  let history = [{
    ...
    projects: [{item:`I.CXO-billpay — JPMC 
    ...
    `,time:'Time Period : 2022-aug-01 to 2023-apr-04'}, {item:`II.ESG - JPMC, Environment Social and Governance : This is new requirement under TAD seal for enabling users to create various combinations of Product under ESG based on available selections and getting approval for them if neede.
    `,time:'Time Period : 2022-jan-01 to 2022-july-06'}, {item:`III.VES - JPMC, Verification Engineering Services : validating that a Set of Development and Testing practices to increase the overall quality of feature delivery and decrease time to market are completed.These Practices and tooling adoption applies to all Technology stacks as well as modernized and non-modernized application. VES will provide a suite of tools for the teams to use so that the Acceptance Criteria can be met, which will include capabilities for the teams to use their own tooling, and send the data to VDE framework to be used in the Acceptance Criteria step. Complete these tasks to get started `,time:'Time Period : 2021-apr-04 to 2021-dec-04'},
      {item:`IV.GCB - CITI , This is US web internet banking application. In application user can see their bank account, credit card, debit card details. I have worked on the application where user can see personalized offer based on account transcation history.`,time:'Time Period : 2020-mar-20 to 2021-apr-04'}],
  ...
  },
  {
    ...
    projects: [{item:`I.pmi-projct management information, it is used for employees to get project releated information and employee communicatio to use chatting and video.
  ...
  },
  {
    ...
    `,time:'Time Period : 30 Oct 2018 to 08 Nov 2019'}, {item:`II.TIW— DBS 
  ...
  },
  {
    ...
    projects: [{item:`I.MAGNETONE TEAM 
  ...
  },
  {
    ...
    projects: [{item:`I.TOUCH GUIDE — CLICKBASE
    TouchGuide 2.0 is an application running in Kiosk(Touch Screen Systems) at malls. The purpose of this application is to help the customers of the mall to locate shops and services inside the mall. Using this application the user can locate a shop/service on the map. The interactive map will show a path from his/her current location to the destination Shop/service center. TouchGuide is developed as an integrated runtime to develop desktop based RIA (Rich Internet Application). The data is stored in the Kiosk itself and on an interval, the data will be updated from a central Db located over the internet.
       `,time:'Time Period : 01 Oct 2010 to 04 Feb 2013'}, {item:`II.TOUCH ADMIN — CLICKBASE 
