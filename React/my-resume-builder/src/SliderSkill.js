...
function SliderSkill() {
  ...
  useEffect(() => {
    ...
    { label: 'Java Script', value: 4, id: 3 }, { label: 'Type Script', value: 4, id: 3 }, { label: 'Angular 2 ... 19', value: 4, id: 4 },
    { label: 'React js 16 ... 19', value: 4, id: 5 }, { label: 'Vue js 3', value: 3, id: 6 }, { label: 'Karma, jasmine', value: 4, id: 7 },
    { label: 'jest, RTL', value: 4, id: 8 }, { label: 'Cypress', value: 4, id: 9 },
    { label: 'React Native', value: '4', id: 10 },
    { label: 'Node JS', value: '4', id: 11 },
    { label: 'Python', value: 3, id: 12 }, { label: 'TFS', value: 3, id: 16 },
